    ...
    for (let x = 0; x < nCount; x++) {
      for (let y = 0; y < nCount; y++) {
        if (qrcode.isDark(x, y) === false) {
          ...
          pointList.push(
            `<rect width='${size2}' height='${size2}' fill='${upColor}' x='${
              x + (1 - size2) / 2
            }' y='${y + (1 - size2) / 2}' transform='${matrixString}'/>`
          );
          pointList.push(
            `<rect width='${height2}' height='${size2}' fill='${leftColor}' x='${0}' y='${0}' transform='${
              matrixString +
              'translate(' +
          ...
          pointList.push(
            `<rect width='${size2}' height='${height2}' fill='${rightColor}' x='${0}' y='${0}' transform='${
              matrixString +
              'translate(' +
              String(x + (1 - size2) / 2) +
              ',' +
          ...
          pointList.push(
            `<rect width='${size}' height='${size}' fill='${upColor}' x='${
              x + (1 - size) / 2
            }' y='${y + (1 - size) / 2}' transform='${matrixString}'/>`
          );
          pointList.push(
            `<rect width='${height}' height='${size}' fill='${leftColor}' x='${0}' y='${0}' transform='${
              matrixString +
              'translate(' +
          ...
          pointList.push(
            `<rect width='${size}' height='${height}' fill='${rightColor}' x='${0}' y='${0}' transform='${
              matrixString +
              'translate(' +
              String(x + (1 - size) / 2) +
              ',' +
...
<g transform='${matrixString}'>
  <path d='${sq25}' stroke='#FFF' stroke-width='${
          100 / iconSize
        }' fill='#FFF' transform='${
          'translate(' +
          String(iconXY) +
...
<g key='${id++}' transform='${matrixString}'>
  <defs>
    <path id='${
      'defs-path' + randomIdDefs
    }' d='${sq25}' fill='#FFF' transform='${
          'translate(' +
          String(iconXY) +
          ',' +
          String(iconXY) +
