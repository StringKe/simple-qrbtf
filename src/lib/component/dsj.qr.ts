      ...
      for (let x = 0; x < nCount; x++) {
        if (qrcode.isDark(x, y) === false) {
          ...
          if (posType === Type.Rect) {
            pointList.push(
              `<rect width='${1}' height='${1}' fill='#0B2D97' x='${x}' y='${y}'/>`
            );
          } else if (posType === Type.Dsj) {
            pointList.push(
              `<rect width='${3 - (1 - width3)}' height='${
                3 - (1 - width3)
              }' fill='#0B2D97' x='${x - 1 + (1 - width3) / 2}' y='${
                y - 1 + (1 - width3) / 2
              }'/>`
            );
            pointList.push(
              `<rect width='${width3}' height='${
                3 - (1 - width3)
              }' fill='#0B2D97' x='${x - 3 + (1 - width3) / 2}' y='${
                y - 1 + (1 - width3) / 2
              }'/>`
            );
            pointList.push(
